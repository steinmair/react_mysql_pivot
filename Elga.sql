...
--  Summe der Anzahl der medizinischen Fälle pro Arzt über die Zeit:
...
--  vorherige Diagnose für jeden medizinischen Fall, gruppiert nach Patient und sortiert nach Datum:
...
SELECT
    PATIENT.PATIENT_ID,
    PATIENT.SURNAME,
    COUNT(*) OVER (PARTITION BY PATIENT_ID) AS Cases_Count
FROM
    MEDICAL_CASE
JOIN PATIENT ON MEDICAL_CASE.PATIENT_ID = PATIENT.PATIENT_ID
;


show columns from MEDICAL_CASE;
